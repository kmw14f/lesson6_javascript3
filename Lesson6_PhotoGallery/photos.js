...
function previewFive() {
   ...
   //add or attatch the fifth image to preview
...
//the left arrow()function will be excecuted when the user clicks the left navigation arrow button
...
//the rightArrow() function will be excecuted when user clicks the right navigation arrow
